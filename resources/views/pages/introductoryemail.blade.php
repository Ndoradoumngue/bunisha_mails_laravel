	...
	<div class="body-div">
        ...
        <div class="waiting-section">
            ...
            <div class="centered">
                ...
                <div class="centered">
                    <br/>
                    <a href="https://www.bunisha.com/services/tenders" class="view-more-button">&nbsp;&nbsp;&nbsp;&nbsp; View More &nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <br/>
                </div>
            </div>
        </div>
        ...
        <div class="pre-qualification-section">
            ...
            <div class="centered">
                <br/>
                <a href="https://www.bunisha.com/services/tenders" class="view-in-browser-button">&nbsp;&nbsp;&nbsp;&nbsp; Read More &nbsp;&nbsp;&nbsp;&nbsp;</a>
                <br/>
            </div>
        </div>
        ...
        <div class="waiting-section">
            ...
            <div class="centered">
                <br/>
                <a href="https://www.bunisha.com/services/tenders" class="view-more-button">&nbsp;&nbsp;&nbsp;&nbsp; Subscribe &nbsp;&nbsp;&nbsp;&nbsp;</a>
                <br/>
            </div>
        </div>
