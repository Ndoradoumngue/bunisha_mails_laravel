...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="stylesheet" href="http://www.fontsaddict.com/fontface/fontastique-fontastique.ttf">
    ...
    <body>
    	...
    	<div class="whole-mail">
			...
			<div class="centered">
				<a class="view-tender-listing-button" href="https://www.bunisha.com/services/tenders">View tender listing</a>
			</div>
